package ch.unibas.roo.torrus.client.scaffold.place;
 ...
 * {@link ch.unibas.roo.torrus.client.scaffold.place.Place Place}s your app can navigate to. In
 ...
 * {@link ch.unibas.roo.torrus.client.scaffold.place.ProxyListPlace ProxyListPlace}s (which show
 * all entities of a particular type) and
 * {@link ch.unibas.roo.torrus.client.scaffold.place.ProxyPlace ProxyPlace}s (which give access to
