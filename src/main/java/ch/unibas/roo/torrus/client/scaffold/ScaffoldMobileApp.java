...
import ch.unibas.roo.torrus.client.managed.activity.*;
import ch.unibas.roo.torrus.client.managed.request.ApplicationRequestFactory;
import ch.unibas.roo.torrus.client.managed.ui.ApplicationListPlaceRenderer;
import ch.unibas.roo.torrus.client.scaffold.activity.IsScaffoldMobileActivity;
import ch.unibas.roo.torrus.client.scaffold.place.*;
import ch.unibas.roo.torrus.client.scaffold.gae.GaeHelper;
import ch.unibas.roo.torrus.client.style.MobileListResources;
