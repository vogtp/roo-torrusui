...
public abstract class DeviceDetailsView_Roo_Gwt extends Composite implements ProxyDetailsView<DeviceProxy> {
    ...
    public void setValue(DeviceProxy proxy) {
        ...
        displayRenderer.setInnerText(DeviceProxyRenderer.instance().render(proxy));
    }
}
